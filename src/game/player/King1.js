...
export default class King1 extends BaseCharacter {
    constructor(w,h) {
    ...
    buildAnimation(scene) {
        ...
        this.createAnimation(scene, this.keyJump, this.keyJump, 'sprite', 1, 0, 1, 1,1)
        ...
        this.createAnimation(scene, this.keyAttack3, this.keyAttack3, 'sprite', 4, 0, 12, 0)
        this.createAnimation(scene, this.keyHit, this.keyHit, 'sprite', 4, 0, 8, 0)
        this.createAnimation(scene, this.keyDeath, this.keyHit, 'sprite', 2, 0, 2, 0, 1)
    ...
    attack3(enemy) {
        ...
        this.player.anims.play(`${this.name}-attack3`, true).once('animationcomplete', () => {
            ...
            this.hitEnemy(enemy, 200, 90, damage)
