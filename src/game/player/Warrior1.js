...
export default class Warrior1 extends BaseCharacter {
    ...
    buildAnimation(scene) {
        this.createAnimation(scene, this.keyIdle, this.keyIdle, 'sprite', 10, 0, 5, -1)
        this.createAnimation(scene, this.keyWalk, this.keyWalk, 'sprite', 8, 0, 8, -1)
        this.createAnimation(scene, this.keyJump, this.keyJump, 'sprite', 3, 0, 1, 1)
        this.createAnimation(scene, this.keyAttack1, this.keyAttack1, 'sprite', 7, 0, 12, 0)
        this.createAnimation(scene, this.keyAttack2, this.keyAttack2, 'sprite', 7, 0, 12, 0)
        ...
        // this.createAnimation(scene, this.keyDeath, this.keyDeath, 'sprite', 7, 0, 5, 0)
